...
auto-downloaded to ~/.memorus/models/ on first use and cached for offline
...
_DEFAULT_MODEL_DIR = os.path.join(os.path.expanduser("~"), ".memorus", "models")
...
class ONNXEmbedder(EmbeddingBase):
    ...
    model_dir : str, optional
        Directory for cached model files.  Defaults to ``~/.memorus/models/``.
